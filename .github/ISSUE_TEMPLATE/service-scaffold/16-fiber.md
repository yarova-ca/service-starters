---
name: "[16 Go] Fiber 3.0 — service scaffold"
about: "Minimal runnable Fiber 3.0 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/16-fiber issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Fiber 3.0`.

Companion issue in `pipeline-studio`: `[16 Go] Fiber 3.0 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Fiber 3.0","version":"1.0.0"}` |
...
**Extra setup:** Go 1.23 LTS; CGO_ENABLED=0; fasthttp-based
