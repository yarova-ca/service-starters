---
name: "[02 CSR/SPA] React 19 — service scaffold"
about: "Minimal runnable React 19 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/02-react issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `React 19`.

Companion issue in `pipeline-studio`: `[02 CSR/SPA] React 19 — pipeline setup`
