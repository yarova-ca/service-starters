---
name: "[17 Java] Micronaut 5.0 — service scaffold"
about: "Minimal runnable Micronaut 5.0 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/17-micronaut issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Micronaut 5.0
**Category:** 17 Java
**Slug:** `17-micronaut`
...
This issue tracks creating the minimal runnable starter app for `Micronaut 5.0`.

Companion issue in `pipeline-studio`: `[17 Java] Micronaut 5.0 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Micronaut 5.0","version":"1.0.0"}` |
...
**Extra setup:** Java 21 LTS; micronaut-management for /health endpoint
