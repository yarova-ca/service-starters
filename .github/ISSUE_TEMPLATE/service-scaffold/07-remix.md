---
name: "[07 Streaming SSR] Remix 7 — service scaffold"
about: "Minimal runnable Remix 7 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/07-remix issue for the full picture."
...
Companion issue in `pipeline-studio`: `[07 Streaming SSR] Remix 7 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Remix 7","framework":"07-remix","version":"1.0.0"}` |
...
**Extra setup:** adapter-node; streaming enabled by default in Remix v7
