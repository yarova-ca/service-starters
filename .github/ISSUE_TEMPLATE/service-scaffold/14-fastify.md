---
name: "[14 Node/Deno/Bun] Fastify 5.2 — service scaffold"
about: "Minimal runnable Fastify 5.2 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/14-fastify issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Fastify 5.2`.

Companion issue in `pipeline-studio`: `[14 Node/Deno/Bun] Fastify 5.2 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Fastify 5.2","framework":"14-fastify","version":"1.0.0"}` |
...
**Extra setup:** TypeScript; @fastify/type-provider-typebox recommended
