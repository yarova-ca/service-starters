---
name: "[16 Go] Chi 5.2 — service scaffold"
about: "Minimal runnable Chi 5.2 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/16-chi issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Chi 5.2`.

Companion issue in `pipeline-studio`: `[16 Go] Chi 5.2 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Chi 5.2","version":"1.0.0"}` |
