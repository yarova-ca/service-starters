---
name: "[01 SSR/Hybrid] SvelteKit 2.57 — service scaffold"
about: "Minimal runnable SvelteKit 2.57 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/01-sveltekit issue for the full picture."
...
Companion issue in `pipeline-studio`: `[01 SSR/Hybrid] SvelteKit 2.57 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from SvelteKit 2.57","framework":"01-sveltekit","version":"1.0.0"}` |
...
**Extra setup:** @sveltejs/adapter-node required
