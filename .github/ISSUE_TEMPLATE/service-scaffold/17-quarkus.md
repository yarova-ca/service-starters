---
name: "[17 Java] Quarkus 3.35 — service scaffold"
about: "Minimal runnable Quarkus 3.35 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/17-quarkus issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Quarkus 3.35
**Category:** 17 Java
**Slug:** `17-quarkus`
...
This issue tracks creating the minimal runnable starter app for `Quarkus 3.35`.

Companion issue in `pipeline-studio`: `[17 Java] Quarkus 3.35 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Quarkus 3.35","version":"1.0.0"}` |
...
**Extra setup:** Java 21 LTS; quarkus-smallrye-health extension for /q/health
