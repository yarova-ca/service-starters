---
name: "[03 SSG] Eleventy 3.0 — service scaffold"
about: "Minimal runnable Eleventy 3.0 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/03-eleventy issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Eleventy 3.0
**Category:** 03 SSG
**Slug:** `03-eleventy`
...
This issue tracks creating the minimal runnable starter app for `Eleventy 3.0`.

Companion issue in `pipeline-studio`: `[03 SSG] Eleventy 3.0 — pipeline setup`
...
**Extra setup:** Health endpoints: static JSON files in _data/health/
