---
name: "[08 Micro-frontends] single-spa 6.0 — service scaffold"
about: "Minimal runnable single-spa 6.0 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/08-single-spa issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** single-spa 6.0
...
This issue tracks creating the minimal runnable starter app for `single-spa 6.0`.

Companion issue in `pipeline-studio`: `[08 Micro-frontends] single-spa 6.0 — pipeline setup`
...
**Extra setup:** Root config + one micro-app; health as static JSON files
