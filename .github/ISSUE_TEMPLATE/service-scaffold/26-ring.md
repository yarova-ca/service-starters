---
name: "[26 Clojure] Ring 1.12 — service scaffold"
about: "Minimal runnable Ring 1.12 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/26-ring issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Ring 1.12`.

Companion issue in `pipeline-studio`: `[26 Clojure] Ring 1.12 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Ring 1.12","version":"1.0.0"}` |
...
**Extra setup:** Clojure 1.12 LTS + Java 21; /health route in ring handler
