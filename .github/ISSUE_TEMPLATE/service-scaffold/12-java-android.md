---
name: "[12 Native Android] Java Android SDK 17 — service scaffold"
about: "Minimal runnable Java Android SDK 17 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/12-java-android issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Java Android SDK 17
**Category:** 12 Native Android
**Slug:** `12-java-android`
...
This issue tracks creating the minimal runnable starter app for `Java Android SDK 17`.

Companion issue in `pipeline-studio`: `[12 Native Android] Java Android SDK 17 — pipeline setup`
