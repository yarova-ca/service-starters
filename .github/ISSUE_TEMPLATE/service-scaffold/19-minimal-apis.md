---
name: "[19 .NET] Minimal APIs .NET 9 — service scaffold"
about: "Minimal runnable Minimal APIs .NET 9 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/19-minimal-apis issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Minimal APIs .NET 9
**Category:** 19 .NET
**Slug:** `19-minimal-apis`
...
This issue tracks creating the minimal runnable starter app for `Minimal APIs .NET 9`.

Companion issue in `pipeline-studio`: `[19 .NET] Minimal APIs .NET 9 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Minimal APIs .NET 9","version":"1.0.0"}` |
...
**Extra setup:** .NET 9 LTS; app.MapHealthChecks("/health") pattern
