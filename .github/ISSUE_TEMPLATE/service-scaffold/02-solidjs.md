---
name: "[02 CSR/SPA] Solid.js 2.0 — service scaffold"
about: "Minimal runnable Solid.js 2.0 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/02-solidjs issue for the full picture."
labels: service-scaffold
assignees: ''
---

**Framework:** Solid.js 2.0
**Category:** 02 CSR/SPA
**Slug:** `02-solidjs`
...
This issue tracks creating the minimal runnable starter app for `Solid.js 2.0`.

Companion issue in `pipeline-studio`: `[02 CSR/SPA] Solid.js 2.0 — pipeline setup`
