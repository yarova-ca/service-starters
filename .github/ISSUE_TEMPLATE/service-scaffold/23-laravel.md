---
name: "[23 PHP] Laravel 12 — service scaffold"
about: "Minimal runnable Laravel 12 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/23-laravel issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Laravel 12`.

Companion issue in `pipeline-studio`: `[23 PHP] Laravel 12 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Laravel 12","version":"1.0.0"}` |
...
**Extra setup:** PHP 8.3 LTS; /health route in routes/api.php; php-fpm + nginx sidecar
