---
name: "[06 Edge Rendering] Hono 4.7 — service scaffold"
about: "Minimal runnable Hono 4.7 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/06-hono-edge issue for the full picture."
...
Companion issue in `pipeline-studio`: `[06 Edge Rendering] Hono 4.7 — pipeline setup`
...
**Extra setup:** Deploys to Cloudflare Workers — no Docker
