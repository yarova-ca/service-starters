---
name: "[20 Rust] Actix-web 4.9 — service scaffold"
about: "Minimal runnable Actix-web 4.9 service with hello world, health/liveness/readiness endpoints, tests, and .env.example. Run alongside pipeline-studio/20-actix-web issue for the full picture."
...
This issue tracks creating the minimal runnable starter app for `Actix-web 4.9`.

Companion issue in `pipeline-studio`: `[20 Rust] Actix-web 4.9 — pipeline setup`
...
| Route | Response |
|---|---|
| `GET /` | `{"message":"Hello from Actix-web 4.9","version":"1.0.0"}` |
